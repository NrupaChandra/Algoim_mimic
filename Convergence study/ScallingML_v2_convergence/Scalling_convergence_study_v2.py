...
data_path  = r"C:\Git\Algoim_mimic\Convergence study\ScallingML_v2_convergence\text_data\cut_subcell_polynomials_p1_data.txt"
summary_path = r"C:\Git\Algoim_mimic\Convergence study\ScallingML_v2_convergence\text_data\subcell_classification_summary.txt"
...
base_folder = r"C:\Git\Algoim_mimic\Convergence study\ScallingML_v2_convergence"
...
def load_ml_weights_map():
    ...
    with torch.no_grad():
        for i, id_str in enumerate(ids):
            ...
            pred_scale_x, pred_scale_y, pred_center_x, pred_center_y = model(exp_x_t, exp_y_t, coeff_t)
...
def true_area():
    """
    Same analytic true area as in Algoim convergence script.
    """
    a = mp.mpf("-0.018251")
    b = mp.mpf("-0.56895")
    c = mp.mpf("-0.11769")
...
def main():
    ...
    # Log–log convergence plot (same style as Algoim one)
    plt.figure()
