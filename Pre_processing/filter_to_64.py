...
output_path = Path(r"C:\Git\Algoim_mimic\Pre_processing\text_data\1kTestBernstein_p1_output_8.txt")
input_path  = Path(r"C:\Git\Algoim_mimic\Pre_processing\text_data\1kTestBernstein_p1_data.txt")
